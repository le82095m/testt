...
public class Request implements HttpServletRequest {
    ...
    public Request(String method, String requestURI, String contextPath, String servletPath, String host, Map<String, String> parameter, Map<String, String> headers, Map<String, Cookie> cookies) throws IOException, ClassNotFoundException {
        this.method = method;
